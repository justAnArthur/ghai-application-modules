package fiit.vava.client.routes.client.documents;
...
public class Controller {
    ...
    @FXML
    void handleToProfileBtn(ActionEvent event) throws IOException {
        Router.getInstance().navigateTo("client/profile");
    }

    @FXML
    void handleAddPassport(ActionEvent event) throws IOException {
        Router.getInstance().showModal("client/documents/addPassport");
    }
